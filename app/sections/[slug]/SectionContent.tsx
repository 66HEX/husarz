...
export default function SectionContent({ section }: SectionContentProps) {
    ...
    return (
        <div id="section-content" className="bg-background pt-20 md:pt-24 pb-4 md:pb-8">
            <div className="px-2 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    ...
                    >
                        <div
                            ref={imageRef}
                            className="relative w-full h-full aspect-square opacity-0">
                            <Image
                                ...
                                onError={(e) => {
                                    ...
                                    // Uruchamiamy animacje nawet jeśli obraz się nie załadował
                                    setImageLoaded(true);
                                }}
                            />
                        </div>
